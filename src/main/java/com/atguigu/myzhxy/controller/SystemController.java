...
public class SystemController {
    ...
    * */
    ...
    public Result headerImgUpload(
        ...
        String portraitPath="C:/Users/wei/IdeaProjects/myzhxy/target/classes/public.upload/".concat(newFileName);
        try {
    ...
    @ApiOperation("通过token的口令获取当前登陆的用户信息的方法")
    @GetMapping("/getInfo")
    ...
    @PostMapping("/login")
    public Result login(
            @ApiParam("登陆提交的form表达")@RequestBody LoginForm loginForm,
            HttpServletRequest request
    ) {
        //验证码校验
